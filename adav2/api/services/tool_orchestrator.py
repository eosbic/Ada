...
async def collect_multi_source_context(message: str, empresa_id: str, intent: str = "data_query") -> Dict:
    ...
    needs_project = any(k in q for k in ["proyecto", "tarea", "issue", "sprint", "plane", "bootcamp", "piloto", "kanban", "backlog", "asignado"])
    needs_notion = any(k in q for k in ["notion", "wiki", "documento", "base de conocimiento", "notas", "pagina", "apuntes"])
