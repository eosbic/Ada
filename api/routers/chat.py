                ...
                try:
                    ...
                    return {
                        "response": (
                            ...
                            f"💡 ¿Quieres que le reenvíe un recordatorio si no responde en unos días? Solo dime \"hazle seguimiento\"."
                        ),
                        "intent": "email",
                        "model_used": "hitl",
                    }
...
- NO incluir markdown en el JSON"""
    ...
    # ── HITL: Si el email_agent pidió más info, guardar estado de composición ──
        ...
        if any(phrase in response_lower for phrase in composing_phrases):
            ...
            # Detectar si el mensaje original ya tiene contenido ("dile que...", "y que...")
